    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index2.html" class="logo">
          ...
          <span class="logo-lg"><b>ADminVentas</b></span>
        </a>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs">David Calderon</span>
                </a>
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <p>
                      ...
                      <small>Email: wdcalderon75@misena.edu.co</small>
                    </p>
                  </li>
            ...
            <div class="col-md-12">
              <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title">Administrador de Ventas</h3>
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2019-2020 <a href="https://davidcalderonleon.wixsite.com/agencia-novografik">NovoGrafik</a>.</strong>Todos los derechos reservados.
      </footer>
